...
class EmployeeDepartmentApi extends Controller
{
    ...
    public function index(Request $request)
    {
       if($request["page"])
       {
           $this->response = Employee_department::paginate($request["limit"]);
       ...
       {
           $this->response = Employee_department::get();
           if(count($this->response) !=0)
           {
              return response(array("data"=>$this->response),200)->header("Content-Type","application/json");
           }
    ...
    public function store(Request $request)
    {
      ...
      $this->response = Employee_department::create($request->all());
      if($this->response)
      {
    ...
    public function show($id)
    {
      ...
      $this->response = Employee_department::where("id",$id)->get();
      if(count($this->response) !=0)
      {
         return response(array("data"=>$this->response),200)->header("Content-Type","application/json");
      }
    ...
    {
        $this->response = Employee_department::where("id",$id)->update(array(
    ...
    {
        $this->response = Employee_department::where("id",$id)->delete();
        if($this->response)
        {
